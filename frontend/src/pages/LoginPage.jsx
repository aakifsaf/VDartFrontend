  ...
  <div className="flex w-full max-w-7xl h-full z-0">
    ...
    <div className="w-full md:w-1/2 flex flex-col justify-center items-center px-8 py-16 bg-green-100">
      <div className="w-full max-w-md pr-10">
        <h2 className="text-sm font-semibold text-center text-blue-900 mb-6">Login</h2>
        ...
        {/* Login Button */}
        <div className="w-full text-right pr-36">
        ...
        <div className="text-xs text-center mt-6 text-gray-700">
          Don’t Have An Account? <a href="/register" className="text-blue-900 font-medium hover:underline">Sign Up</a>
        </div>
      </div>
    </div>
  </div>
